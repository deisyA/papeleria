...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-08-2021 a las 08:43:34
...
CREATE TABLE `detalle_movimiento` (
  `id_detalle_movimiento` int(15) NOT NULL,
...
INSERT INTO `detalle_movimiento` (`id_detalle_movimiento`, `id_producto`, `id_tipo`, `cantidad_detalle`, `valor`, `valor_unitario`, `fecha_registro`) VALUES
(42, 18, 1, 3, 4500, 1500, '2021-08-12 04:39:44.252334'),
(43, 18, 2, 1, 2500, 2500, '2021-08-12 04:43:21.035527');
...
CREATE TABLE `entrada_producto` (
  ...
  `id_producto` int(15) NOT NULL,
  `id_factura` int(15) NOT NULL DEFAULT 1111,
  ...
  `ganancia_unitario` float DEFAULT NULL,
...
CREATE TABLE `factura` (
  ...
  `id_proveedor` int(15) NOT NULL DEFAULT 0,
  `id_documento` varchar(30) NOT NULL,
...
CREATE TABLE `inventario` (
  ...
  `id_producto` int(15) NOT NULL,
  `entradas` int(15) DEFAULT 0,
  `salidas` int(15) DEFAULT 0,
  `existencias` int(15) DEFAULT 0,
  `fecha_registro` timestamp(6) NOT NULL DEFAULT current_timestamp(6)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `inventario` (`id_inventario`, `id_producto`, `entradas`, `salidas`, `existencias`, `fecha_registro`) VALUES
(7, 18, 3, 1, 2, '2021-08-12 04:14:32.857989');
...
CREATE TABLE `producto` (
  ...
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `creador_registro` int(15) NOT NULL,
  `activo_producto` int(2) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `producto` (`id_producto`, `nombre_producto`, `referencia_producto`, `marca_producto`, `color_producto`, `presentacion`, `imagen`, `peso`, `tipo_medida`, `tamaño`, `descripcion_producto`, `palabras_clave`, `fecha_creacion`, `creador_registro`, `activo_producto`) VALUES
(18, 'marcador', 'touch soft head', 'superior', 'Color', 'individual', '', 0, '', 'mediano ', 'marcador permanente doble punta', 'escolar marcador plumon borrable', '2021-08-12 04:14:32', 26, 1);
...
INSERT INTO `proveedor` (`id_proveedor`, `nombre_proveedor`, `telefono_proveedor`, `telefono_dos`, `nit`, `direccion`, `productos_proveedor`, `descripcion_proveedor`) VALUES
(1, 'predeterminado', 123, 123, '123', '123', 'predeterminado', 'predeterminado');
...
CREATE TABLE `salida_producto` (
  ...
  `precio_venta_unitario` float DEFAULT NULL,
  `responsable_salida` varchar(30) NOT NULL DEFAULT '111',
  `creador_registro` int(15) NOT NULL,
...
INSERT INTO `tipo_movimiento` (`id_tipo`, `tipo`, `movimiento`) VALUES
(1, 1, 'entrada'),
(2, 0, 'salida');
...
CREATE TABLE `usuario` (
  ...
  `activo_usuario` int(2) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `usuario` (`id_usuario`, `nombre_usuario`, `correo`, `password`, `fecha`, `id_rol`, `id_empleado`, `activo_usuario`) VALUES
(24, 'user', 'user@user', '$2a$08$r7WUanQ1vXFxALaedp8I4OprYK5jfK2wVMoetZxJQcFtw/VsAGosq', '2021-08-02 18:05:07', 1, 1, 1),
(26, 'Daniela Castro Gómez', 'daniela@correo.com', '$2a$08$quvfnNNd3TybXV6QjoZ3heA5qarv1MeXrw0UVhu/FQ0LU7R0Cr2IK', '2021-08-12 04:08:32', 2, 2, 1);
...
--
ALTER TABLE `detalle_movimiento`
  MODIFY `id_detalle_movimiento` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `entrada_producto`
--
ALTER TABLE `entrada_producto`
  MODIFY `id_entrada_producto` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `existencia`
--
ALTER TABLE `existencia`
  MODIFY `id_existencia` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `inventario`
  MODIFY `id_inventario` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `proveedor`
  MODIFY `id_proveedor` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `salida_producto`
  MODIFY `id_salida_producto` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tipo_movimiento`
--
ALTER TABLE `tipo_movimiento`
  MODIFY `id_tipo` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `detalle_movimiento`
  ADD CONSTRAINT `detalle_movimiento_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalle_movimiento_ibfk_2` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_movimiento` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE;
